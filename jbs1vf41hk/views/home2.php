...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?= base_url()."assets/fusion-opl/" ?>assets/css/bootstrap.min.css" >
    <!-- Icon -->
    <link rel="stylesheet" href="<?= base_url()."assets/fusion-opl/" ?>assets/fonts/line-icons.css">
    <!-- Owl carousel -->
    <link rel="stylesheet" href="<?= base_url()."assets/fusion-opl/" ?>assets/css/owl.carousel.min.css">
    <link rel="stylesheet" href="<?= base_url()."assets/fusion-opl/" ?>assets/css/owl.theme.css">
    
    <!-- Animate -->
    <link rel="stylesheet" href="<?= base_url()."assets/fusion-opl/" ?>assets/css/animate.css">
    <!-- Main Style -->
    <link rel="stylesheet" href="<?= base_url()."assets/fusion-opl/" ?>assets/css/main.css">
    <!-- Responsive Style -->
    <link rel="stylesheet" href="<?= base_url()."assets/fusion-opl/" ?>assets/css/responsive.css">
  ...
  <body>
    ...
    <script src="<?= base_url()."assets/fusion-opl/" ?>assets/js/jquery-min.js"></script>
    <script src="<?= base_url()."assets/fusion-opl/" ?>assets/js/popper.min.js"></script>
    <script src="<?= base_url()."assets/fusion-opl/" ?>assets/js/bootstrap.min.js"></script>
    <script src="<?= base_url()."assets/fusion-opl/" ?>assets/js/owl.carousel.min.js"></script>
    <script src="<?= base_url()."assets/fusion-opl/" ?>assets/js/wow.js"></script>
    <script src="<?= base_url()."assets/fusion-opl/" ?>assets/js/jquery.nav.js"></script>
    <script src="<?= base_url()."assets/fusion-opl/" ?>assets/js/scrolling-nav.js"></script>
    <script src="<?= base_url()."assets/fusion-opl/" ?>assets/js/jquery.easing.min.js"></script>  
    <script src="<?= base_url()."assets/fusion-opl/" ?>assets/js/main.js"></script>
    <script src="<?= base_url()."assets/fusion-opl/" ?>assets/js/form-validator.min.js"></script>
    <script src="<?= base_url()."assets/fusion-opl/" ?>assets/js/contact-form-script.min.js"></script>
